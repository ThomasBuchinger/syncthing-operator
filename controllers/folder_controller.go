...
//+kubebuilder:rbac:groups=syncthing.buc.sh,resources=folders,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=syncthing.buc.sh,resources=folders/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=syncthing.buc.sh,resources=folders/finalizers,verbs=update
